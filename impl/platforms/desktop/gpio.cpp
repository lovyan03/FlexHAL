...
SimulatedPin::SimulatedPin(int pin_number)
...
void SimulatedGPIOPort::drawPin(SDL_Renderer* renderer, int x, int y, int width, int height, PinState state, int pin_number) {
    // ピンの背景色を状態に応じて設定
    switch (state) {
