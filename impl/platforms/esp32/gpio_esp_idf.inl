...
ESP32IDFPin::ESP32IDFPin(int pin_number) : pin_number_(pin_number), current_mode_(PinMode::Undefined)
{
    // 初期化時は何もしない
}
...
void ESP32IDFPin::setAnalogValue(uint8_t value)
{
    ...
    static const ledc_channel_t LEDC_CHANNEL_NUM =
        (ledc_channel_t)(pin_number_ % 8);  // チャンネルはピン番号から割り当て
    ...
    // LEDCチャンネルの設定
    ledc_channel_config_t ledc_channel = {.gpio_num   = (gpio_num_t)pin_number_,
