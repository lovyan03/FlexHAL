...
public:
     ...
     */
    virtual std::shared_ptr<ISPITransport> createTransport(
...
public:
     ...
     * @return std::shared_ptr<ISPITransport> トランスポート
     */
    virtual std::shared_ptr<ISPITransport> getTransport(
        const SPIDeviceConfig& device_config,
...
public:
    ...
    std::shared_ptr<ISPITransport> getTransport(
        const SPIDeviceConfig& device_config,
